...
export default function LeadModal({
  ...
  return (
    <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center p-4" onClick={onClose}>
      <div className="bg-white rounded-xl w-full max-w-[560px] max-h-[90vh] max-md:max-h-[100vh] max-md:rounded-none max-md:max-w-full overflow-y-auto" onClick={(e) => e.stopPropagation()}>
