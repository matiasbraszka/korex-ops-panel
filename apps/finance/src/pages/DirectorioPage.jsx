        ...
        {loading ? (
          ...
          <>
            <div style={{ padding: '18px 22px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 14 }}>
              ...
              <div><label style={lab}>{esCliente ? 'Conector' : 'Referente'} <span style={{ color: '#9AA4B2', fontWeight: 400 }}>· {esCliente ? 'quién trajo al cliente' : 'quién lo trajo / afiliado'}</span></label><input value={data.conector_e || ''} onChange={(e) => set('conector_e', e.target.value)} placeholder="(opcional)" style={inp} /></div>
