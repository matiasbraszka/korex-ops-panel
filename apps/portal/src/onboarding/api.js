      ...
      return {
        ...
        sesion: [
          { titulo: 'Resolvemos tus dudas del onboarding',
            texto: 'Repasamos juntos lo que completaste aquí. Por eso es fundamental que lo termines antes de la reunión.' },
          { titulo: 'Configuramos tu Meta Business', aviso: true,
            texto: 'Necesitas tener acceso a una página de Facebook y a un Instagram. Si no los tienes, vamos a tener que reagendar.' },
          { titulo: 'Dejamos definidos los próximos pasos',
            texto: 'Qué hacemos nosotros, qué necesitamos de ti y cuándo sale cada cosa.' },
        ],
