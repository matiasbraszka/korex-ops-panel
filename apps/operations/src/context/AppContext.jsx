...
export function AppProvider({ children }) {
  ...
  const clientRow = (c) => ({
    ...
    funnels_producto: c.funnelsProducto ?? null, funnels_reclutamiento: c.funnelsReclutamiento ?? null,
  ...
  const CLIENT_FIELD_TO_COL = {
    ...
    funnelsProducto: 'funnels_producto', funnelsReclutamiento: 'funnels_reclutamiento',
    ...
    try {
      ...
      if (sbClients && sbClients.length > 0) {
        const mappedClients = sbClients.map(c => ({
          ...
          funnelsProducto: c.funnels_producto ?? null, funnelsReclutamiento: c.funnels_reclutamiento ?? null,
