...
Deno.serve(async (req) => {
        ...
        avatars: {
          ...
          items: {
            ...
            properties: {
              ...
              spec_start: { type: "string", description: "Las primeras ~12 palabras EXACTAS (copiadas del DEL, con tildes/mayúsculas) donde EMPIEZA el fragmento de ESTE avatar dentro de esa sección." },
  ...
  const prompt = [
    ...
    "Para cada avatar indicá spec_section + spec_start (primeras ~12 palabras EXACTAS donde arranca SU parte) + spec_end (últimas ~12 palabras EXACTAS donde termina SU parte, antes del siguiente avatar). El sistema corta ese pedazo TAL CUAL. Copiá las palabras EXACTAS del DEL (con tildes y mayúsculas).",
    "",
