-- Panorama v3 (aplicada a prod vía MCP el 2026-07-28): cada funnel del panorama
-- viaja con su ID (para el salto directo Panorama → campo de configuración) y el
-- cliente con tiene_cuenta (clients.meta_ads cargada). Cambia la firma de retorno
-- (columna nueva tiene_cuenta) → drop + create.
...
returns table(client_id text, client_name text, company text, niche text, n_estrategias integer,
              ...
              tiene_cuenta boolean, estrategias jsonb)
